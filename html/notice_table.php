                        ...
                        <table class="table  table-hover">
                            ...
                            <form  method="post" action="insert2.php">
                                ...
                                <tr><td>公告类型</td><td><select name="fenlei" class="form-control"  >
                                          <option value="tishi1.png">公告</option>
                                          <option value="tishi2.png">通知</option>
                                        </select></td></tr>
                                <tr><td>公告内容</td><td><input type="text" name="usname"  class="form-control" ></td></tr>
                ...
                <div class="panel  panel-default">
                    ...
                    <tr>
                        <table class="table  table-hover">
                            ...
                            $sql="select * from tb_tishixinxi";//准备sql语句
                            ...
                            while ( $row=mysql_fetch_row($xian)) {
                                echo "
                                 <tr data-expanded='true'>
                                   ...
                                   <td>$row[0]</td>                               
                                   <td>$row[1]</td>                               
                                   <td><a href='delete6.php?id=$row[2]'>删除</a></td>
                                   <td><a href='update4.php?id=$row[2]'>修改</a></td>    
                                   </tr>                      
                                ";
                            }
                            ?>
