                ...
                <div class="panel panel-default">
                    ...
                    <div>
                        <table class="table">
                            ...
                            $id=$_GET['id'];
                            $sql="select * from tb_tishixinxi where t_id=$id";//准备sql语句
                            $xian=$mysqldb->select($sql);
                            $row=mysql_fetch_row($xian);
                            ?>
                            <form  method="post" action="update4_check.php?id=<?php echo $id ?>">
                                <tr><td>ID</td><td class="col-lg-9" ><input type="text"  class="form-control" disabled  value="<?php echo $row[2] ?>"></td></tr>
                                <tr><td>公告类型</td><td><select name="fenlei" class="form-control"  >
                                            <option <?php  if ($row[0]=='tishi1.png'){echo "selected" ;} ?> value="tishi1.png">公告</option>
                                            <option <?php  if ($row[0]=='tishi2.png'){echo "selected" ;} ?>  value="tishi2.png">通知</option>
                                        </select></td></tr>
                                <tr><td>公告内容</td><td><input type="text" name="usname"  class="form-control"  value="<?php echo $row[1] ?>"></td></tr>
                                <tr><td ><input type="submit"></td><td><a href="notice_table.php">返回 通知公告 表</a></td></tr>
                            </form>
                            </tbody>
                        </table>
                    </div>
