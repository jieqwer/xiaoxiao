                ...
                <div class="panel  panel-default">
                    ...
                    <tr>
                        <table class="table  table-hover">
                            <thead>
                            <tr>
                                <th class="col-lg-4" data-breakpoints="xs">ID</th>
                                <th class="col-lg-4"> 分类Name</th>
                                <th colspan="2" class="col-lg-4">操作</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php
                            ...
                            while ( $row=mysql_fetch_row($xian)) {
                                echo "
                                 <tr data-expanded='true'>
                                   <td>$row[1]</td>
                                   <td>$row[0]</td>                               
                                   <td><a href='delete2.php?id=$row[1]'>删除</a></td>
                                   <td><a href='update2.php?id=$row[1]'>修改</a></td>    
                                   </tr>                      
                                ";
                            }
                            ?>
                ...
                <div class="panel  panel-default">
                    ...
                    <tr>
                        <table class="table  table-hover">
                            <thead>
                            <tr>
                                <th  data-breakpoints="xs">字段名称</th>
                                <th >添加</th>
                            </tr>
                            </thead>
                            <tbody>
                            <form  method="post" action="insert1.php">
                                <tr><td>ID</td><td class="col-lg-9" ><input type="text"  class="form-control" disabled  ></td></tr>
                                <tr><td>次分类Name</td><td><input type="text" name="usname"  class="form-control" ></td></tr>
                                <tr><td>父级分类Name</td><td><select name="fenlei" class="form-control"  >
                                            <?php
                                            include_once("../php/opensql.php");
                                            $sql="select * from tb_classification1 ";//准备sql语句
                                            $xian=$mysqldb->select($sql);
                ...
                <div class="panel  panel-default">
                    ...
                    <tr>
                        <table class="table  table-hover">
                            ...
                            include_once("../php/opensql.php");
                            $sql="select * from tb_classification2 limit $start_from, $num_rec_per_page";//准备sql语句
                            $xian=$mysqldb->select($sql);
                            while ( $row=mysql_fetch_row($xian)) {
                                echo "
                                 <tr data-expanded='true'>
                                   ...
                                   <td>$row[0]</td>                               
                                   <td>$row[1]</td>                               
                                   <td><a href='delete3.php?id=$row[2]'>删除</a></td>
                                   <td><a href='update3.php?id=$row[2]'>修改</a></td>    
                                   </tr>                      
                                ";
                            }
                            ?>
                            <tr >
                                <td colspan="5">
                                    <?php
                                    $sql = "select * from tb_classification2";//查询数据库
                                    ...
                                    echo " <li><a href='classification_table.php?page=1'><b >《</b></a></li> "; // 第一页
                                    echo "<li><a  href='classification_table.php?page=$prev'><i class='fa fa-chevron-left'></i></a></li> "; // 上一页
                                    for ($i=1; $i<=$total_pages; $i++) {
                                        echo "<li><a href='classification_table.php?page=".$i."'>".$i."</a></li> ";
                                    };
                                    echo " <li><a  href='classification_table.php?page=$next''><i class='fa fa-chevron-right'></i></a></li>"; // 下一页
                                    echo "<li><a href='classification_table.php?page=$total_pages'><b >》</b></a></li>"; // 最后一页
                                    echo " </ul></div>";
                                    mysql_close();
                                    ?>
                                </td>
