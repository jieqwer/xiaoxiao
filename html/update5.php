                ...
                <div class="panel panel-default">
                    ...
                    <div>
                        <table class="table">
                            ...
                            $id=$_GET['id'];
                            $sql="select * from tb_user where us_id=$id";//准备sql语句
                            $xian=$mysqldb->select($sql);
                            $row=mysql_fetch_row($xian);
                            ?>
                            <form  method="post" action="update5_check.php?id=<?php echo $id ?>">
                                <tr><td>ID</td><td class="col-lg-9" ><input type="text"  class="form-control" disabled  value="<?php echo $row[2] ?>"></td></tr>
                                <tr><td>用户名</td><td><input type="text" class="form-control" disabled  value="<?php echo $row[0] ?>"></td></tr>
                                <tr><td>密码</td><td><input type="password" name="pass"  class="form-control"  value="<?php echo $row[1] ?>"></td></tr>
                                <tr><td ><input type="submit"></td><td><a href="user_table.php">返回 User 表</a></td></tr>
                            </form>
                            </tbody>
                        </table>
                    </div>
