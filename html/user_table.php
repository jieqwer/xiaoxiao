                        ...
                        <table class="table  table-hover">
                            ...
                            while ( $row=mysql_fetch_row($xian)) {
                                echo "
                                 <tr data-expanded='true'>
                                   ...
                                   <td><a href='delete7.php?id=$row[2]'>删除</a></td>
                                   <td><a href='update5.php?id=$row[2]'>修改</a></td>    
                                   </tr>                      
                                ";
                            }
                            ?>
                            <tr >
                                <td colspan="5">
                                    ...
                                    echo " <li><a href='user_table.php?page=1'><b >《</b></a></li> "; // 第一页
                                    echo "<li><a  href='user_table.php?page=$prev'><i class='fa fa-chevron-left'></i></a></li> "; // 上一页
                                    for ($i=1; $i<=$total_pages; $i++) {
                                        echo "<li><a href='user_table.php?page=".$i."'>".$i."</a></li> ";
                                    };
                                    echo " <li><a  href='user_table.php?page=$next''><i class='fa fa-chevron-right'></i></a></li>"; // 下一页
                                    echo "<li><a href='user_table.php?page=$total_pages'><b >》</b></a></li>"; // 最后一页
                                    echo " </ul></div>";
                                    mysql_close();
                                    ?>
                                </td>
