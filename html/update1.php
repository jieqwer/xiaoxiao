                    ...
                    <div>
                        <table class="table">
                            ...
                            <form  method="post" action="update1_check.php?id=<?php echo $id ?>">
                                <tr><td>ID</td><td class="col-lg-9" ><input type="text"  class="form-control" disabled value="<?php echo $row[7]  ?>"></td></tr>
                                <tr><td>Us_Name</td><td><input type="text" name="usname"  class="form-control" value="<?php echo $row[0]  ?>"></td></tr>
                                <tr><td>分类</td><td><select name="fenlei" class="form-control"  >
                                            <?php
                                            include_once("../php/opensql.php");
                                ...
                                <tr><td>标题</td><td><input type="text" name="tit"  class="form-control" value="<?php echo $row[3]  ?>"></td></tr>
                                <tr><td>图片简介</td><td><input type="text" name="mess"  class="form-control" value="<?php echo $row[4]  ?>"></td></tr>
                                <tr><td>图片文件名称</td><td><input type="text"  name="fil" class="form-control" value="<?php echo $row[5]  ?>"></td></tr>
                                <tr><td>审核状态（0未审核/1通过/2不通过)</td><td>
                                        <select name="shenhe" class="form-control"  >
                                            <option <?php  if ($row[6]==0){echo "selected" ;} ?> value="0">0</option>
                                            <option <?php  if ($row[6]==1){echo "selected" ;} ?>  value="1">1</option>
                                            <option <?php  if ($row[6]==2){echo "selected" ;} ?>  value="2">2</option>
                                        </select></td></tr>
                                <tr><td>发布时间</td><td><input type="text"  name="time" class="form-control" disabled value="<?php echo $row[2]  ?>"></td></tr>
                                <tr><td ><input type="submit"></td><td><a href="find_table.php">返回 Find 表</a></td></tr>
                            </form>
                            </tbody>
                        </table>
                    </div>
