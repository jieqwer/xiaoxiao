                ...
                <div class="panel panel-default">
                    ...
                    <div>
                        <table class="table">
                            ...
                            $id=$_GET['id'];
                            $sql="select * from tb_classification2 where c2id=$id";//准备sql语句
                            $xian=$mysqldb->select($sql);
                            $row=mysql_fetch_row($xian);
                            ?>
                            <form  method="post" action="update3_check.php?id=<?php echo $id ?>">
                                <tr><td>ID</td><td class="col-lg-9" ><input type="text"  class="form-control" disabled value="<?php echo $row[2]  ?>"></td></tr>
                                <tr><td>次分类Name</td><td><input type="text" name="usname"  class="form-control" value="<?php echo $row[0]  ?>"></td></tr>
                                ...
                                <tr><td ><input type="submit"></td><td><a href="classification_table.php">返回 Classification2 表</a></td></tr>
                            </form>
                            </tbody>
                        </table>
                    </div>
